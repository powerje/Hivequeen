#!/usr/bin/env python
#
# Copyright 2012 James Power (jep@outlook.com) 
#
...
"""Minimal interface to pair with and control Google TV.

Currently connecting to only one Google TV at a time is supported.
"""

__author__ = 'jep@outlook.com (James Power)'
